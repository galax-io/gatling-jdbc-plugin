...
public class JdbcProtocolBuilderConnectionSettingsStep {
    private final io.cosmospf.load.jdbc.protocol.JdbcProtocolBuilderConnectionSettingsStep wrapped;

    public JdbcProtocolBuilderConnectionSettingsStep(io.cosmospf.load.jdbc.protocol.JdbcProtocolBuilderConnectionSettingsStep jdbcProtocolBuilderConnectionSettingsStep){
